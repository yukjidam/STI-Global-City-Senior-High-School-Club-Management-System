/* Student-Search.js — global search (Users only: students + advisers) */
(() => {
  ...
  const DEST = {
    user: (id) =>
      `UserProfile.html?id=${encodeURIComponent(id)}&user_id=${encodeURIComponent(id)}&uid=${encodeURIComponent(id)}`
  };
